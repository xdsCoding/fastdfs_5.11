...
#define getPeerIpport(sock, port) \
		getIpport(getpeername, sock, port)
//end

/************ add by xiaods start ***********/
int anetPeerToString(int fd, char *ip, size_t ip_len, int *port);		//获取对端地址
int anetSockName(int fd, char *ip, size_t ip_len, int *port);		//获取本端地址
/************ add by xiaods end ***********/
 ...
 *  return: error no, 0 success, != 0 fail
 *  const short 全部改为 const unsigned short （0 - 65535）		//modify by xiaods
*/
