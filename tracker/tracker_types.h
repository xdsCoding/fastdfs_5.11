...
#define FDFS_MAX_GROUPS		       256
#define FDFS_MAX_TRACKERS		16

//add by yb 20170826 start
#define FDFS_MAX_CLIENTS_EACH_STROAGE     256
//end
...
#define FDFS_STORAGE_ID_MAX_SIZE	46
...
typedef struct
{
	char id[IP_ADDRESS_PORT_SIZE];
	int cout;
	int alloc_cout;
	FDFSClientInfo *clientInfo;
...
typedef struct
{
	int current_count;
	int alloc_count;
	FDFSClientInfo **clients;
	FDFSClientInfo **sorted_clients;
}FDFSStorCliManager;
