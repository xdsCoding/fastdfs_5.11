...
FDFSClientManager g_cli_Manager = {0,0,NULL,NULL};
bool g_reprot_stroage_client_connect = true;
int g__storage_client_connect_chg_count = 0; //storage connect client number reporty
//add by yb 20170816 end
