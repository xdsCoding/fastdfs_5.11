...
int g_stat_storage_client_connect_chg_count = 1;
FDFSStorCliManager g_stor_cli_manager = {0,0,NULL,NULL};
bool g_reprot_stroage_client_connect = false;
pthread_mutex_t mem_thread_lock;
//end
...
/************ add by xiaods start ***********/
char *g_bindaddr[CONFIG_BINDADDR_MAX]; /* Addresses we should bind to */
int g_bindaddr_count = 0;         /* Number of addresses in server.bindaddr[] */
int g_ipfd[CONFIG_BINDADDR_MAX]; /* TCP socket file descriptors */
int g_ipfd_count = 0;             /* Used slots in ipfd[] */
/************ add by xiaods end ***********/
