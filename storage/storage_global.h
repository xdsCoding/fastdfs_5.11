...
//add by yb 20170816
extern int g_stat_storage_client_connect_chg_count;
extern FDFSStorCliManager g_stor_cli_manager;
extern pthread_mutex_t mem_thread_lock;
//end
...
/************ add by xiaods start ***********/
extern char *g_bindaddr[CONFIG_BINDADDR_MAX]; /* Addresses we should bind to */
extern int g_bindaddr_count;        /* Number of addresses in server.bindaddr[] */
extern int g_ipfd[CONFIG_BINDADDR_MAX]; /* TCP socket file descriptors */
extern int g_ipfd_count;;             /* Used slots in ipfd[] */
/************ add by xiaods end ***********/
...
//add by yb 20170816
extern bool g_reprot_stroage_client_connect;
//end
