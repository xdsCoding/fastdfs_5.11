...
/*list all clients of all storages
 * params:
 *   pTrackerServer: tracker server
 *   client_storage_id: storage_ip:storage_prot
 *   clients_infos:return active clients of storage
 *   max_clients:max client count(client array capacity)
